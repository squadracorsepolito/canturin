...
<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 24 24">
	<path
		fill="currentColor"
		d="M14.5 19.982c1.573-.04 2.677-.167 3.5-.567V21a1 1 0 0 1-1 1h-1.5a1 1 0 0 1-1-1zM6 19.415c.823.4 1.927.527 3.5.567V21a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1z"
	/>
	<path
		fill="currentColor"
		fill-rule="evenodd"
		d="M5.172 3.172C6.343 2 8.229 2 12 2c3.771 0 5.657 0 6.828 1.172C19.892 4.235 19.99 5.886 20 9v4c-.01 3.114-.108 4.765-1.172 5.828a3.02 3.02 0 0 1-.828.587c-.823.4-1.927.527-3.5.567C13.773 20 12.946 20 12 20s-1.773 0-2.5-.018c-1.573-.04-2.677-.167-3.5-.567a3.02 3.02 0 0 1-.828-.587C4.108 17.765 4.009 16.114 4 13V9c.01-3.114.108-4.765 1.172-5.828"
		clip-rule="evenodd"
		opacity="0.5"
	/>
	<path
