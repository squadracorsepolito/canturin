...
export const sortableItem: Action<HTMLElement, Options> = (
	el,
	{ instanceId, id, dragHandle, setClosestEdge, setIsDragging }
) => {
...
export function initSortableWrapper<T extends { id: string }>(
	instanceId: string,
	items: T[],
